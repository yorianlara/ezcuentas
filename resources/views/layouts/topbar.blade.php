            ...
            <li class="dropdown d-none d-lg-inline-block topbar-dropdown">
                ...
                <div class="dropdown-menu dropdown-lg dropdown-menu-end p-0">
                    ...
                    <div class="p-2">
                        <div class="row g-0">
                            <div class="col">
                                <a class="dropdown-icon-item" href="{{route('list-products')}}">
                                    <img src="{{URL::asset('/assets/images/cargo-box-bordered.png')}}" alt="Products">
                                    <span>Products</span>
                                </a>
                            </div>
                            <div class="col">
                        ...
                        <div class="row g-0">
                            <div class="col">
                                <a class="dropdown-icon-item" href="#">
                                    <img src="{{URL::asset('/assets/images/labels2.png')}}" alt="Products">
                                    <span>Shipping Labels</span>
                                </a>
                            </div>
                            <div class="col">
                                <a class="dropdown-icon-item" href="#">
                                    <img src="{{URL::asset('/assets/images/cargo-box-bordered.png')}}" alt="G Suite">
