...
@section('content')
@section('pagetitle') Brands @endsection
<!-- start page title -->
    <div class="row">
        <div class="col-12">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <div id="toolbar">
                        <a href="javascript:void(0)" class="btn btn-success mb-2" data-bs-toggle='tooltip' data-placement='top' title='Add Brans' onclick='crear()'>
    ...
    <!-- end row -->
    <!-- Crear marcas -->
    <div class="modal fade" id="modalBrands" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form  class="needs-validation" novalidate id="frmBrands">
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title" id="titulo">Brands</h5>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#modalBrands').on('hide.bs.modal',function(){
            $('#id').val(null);
            $('#name').val(null);
            ...
            $('#frmBrands').removeClass('was-validated');
        });
        ...
        $('#frmBrands').on('submit',function(e){
            e.preventDefault();
            ...
            $.post('{{ route("brands.save")}}',{"id":id,"name":name,"status":status,"_token":token})
            .done(function(data){
    ...
    async function eliminar(id) {
        ...
        {
            let token = "{{ csrf_token() }}";
            $.post('{{ route("brands.delete")}}',{"id":id,"_token":token})
            .done(function(data){
                showToast(data.msg,data.success);
