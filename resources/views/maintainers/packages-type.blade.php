...
@section('title') {{config('app.name')}} | Packages Type @endsection
@section('content')
@section('pagetitle') Packages Type @endsection
<!-- start page title -->
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Packages Type</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <div id="toolbar">
                        <a href="javascript:void(0)" class="btn btn-success mb-2" data-bs-toggle='tooltip' data-placement='top' title='Add Pakage Type' onclick='crear()'>
    ...
    <!-- end row -->
    <!-- Crear marcas -->
    <div class="modal fade" id="modalPackagesType" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form  class="needs-validation" novalidate id="frmPackagesType">
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title" id="titulo">Packages Type</h5>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#modalPackagesType').on('hide.bs.modal',function(){
            $('#id').val(null);
            $('#name').val(null);
            ...
            $('#frmPackagesType').removeClass('was-validated');
        });

        $('#cerrar').on('click',function(){
            $('#modalPackagesType').modal('hide');
        });

        $('#frmPackagesType').on('submit',function(e){
            e.preventDefault();
            ...
            $.post('{{ route("packages-type.save")}}',{"id":id,"name":name,"status":status,"_token":token})
            .done(function(data){
    ...
    async function eliminar(id) {
        ...
        {
            let token = "{{ csrf_token() }}";
            $.post('{{ route("packages-type.delete")}}',{"id":id,"_token":token})
            .done(function(data){
                showToast(data.msg,data.success);
